<template>
    <div class="h-screen flex">
        <div class=" w-1/2 bg-login bg-cover i justify-around items-center">
            <div class = "backgroundimg w-100 h-screen">
                <div class="pt-80 px-20">  
                    <h1 class=" text-white font-bold text-4xl font-sans">Welcome to Chiak</h1>
